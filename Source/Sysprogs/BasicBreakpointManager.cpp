...
Sysprogs::BasicBreakpointManager::BreakpointObject*
Sysprogs::BasicBreakpointManager::TryGetBreakpointAtLocation(
  const std::string& file, int oneBasedLine)
{
  auto it =
...
Sysprogs::BasicBreakpointManager::BreakpointObject*
Sysprogs::BasicBreakpointManager::TryGetBreakpointForFunction(
...
Sysprogs::BasicBreakpointManager::UniqueBreakpointID
Sysprogs::BasicBreakpointManager::CreateBreakpoint(const std::string& file,
                                                   int oneBasedLine)
{
  auto id = m_NextID++;
...
Sysprogs::BasicBreakpointManager::UniqueBreakpointID
Sysprogs::BasicBreakpointManager::CreateBreakpoint(const std::string& function)
{
  auto id = m_NextID++;
...
Sysprogs::BasicBreakpointManager::UniqueBreakpointID
Sysprogs::BasicBreakpointManager::CreateDomainSpecificBreakpoint(
...
Sysprogs::BasicBreakpointManager::BreakpointObject*
Sysprogs::BasicBreakpointManager::TryLookupBreakpointObject(
...
Sysprogs::BasicBreakpointManager::CanonicalFileLocation
Sysprogs::BasicBreakpointManager::MakeCanonicalLocation(
  const std::string& file, int oneBasedLine)
{
